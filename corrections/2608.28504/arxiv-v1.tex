...
\usepackage{hyperref, amssymb, mathtools, url, enumerate}
...
\def\twocell[#1]{\arrow[#1, dash, phantom, "\Rightarrow"{scale=1.125, yshift=-.4pt, description, allow upside down, sloped, inner sep=0pt}]}

\renewcommand\eminnershape{\bfseries}

\newtheoremstyle{mythm}% 
{5pt plus 1pt minus 1pt}% space above
{5pt plus 1pt minus 1pt}% space below
{\slshape}% body font
...
\makeatother
\AtBeginDocument{\renewcommand{\thesection}{\arabic{section}}}
...
\AtBeginEnvironment{claim*}{\let\oldqed=\qedsymbol%
\renewcommand\qedsymbol{$\triangle$}}
\AtEndEnvironment{claim*}{\let\qedsymbol=\oldqed}
...
\newcommand\tobias[1]{\notehelper{#1}{Tobias}{teal}}
\newcommand\emma[1]{\notehelper{#1}{Emma}{orange}}

\newcommand\tobiaslong[1]{{\itshape \color{teal} #1}}
\newcommand\emmalong[1]{{\itshape \color{orange} #1}}
...
\newcommand{\Lhat}{{\widehat{{\smash{\cat{L}}\vphantom{t}}\kern-1.75pt}\kern1.75pt}}
\newcommand{\Lomega}{\cat{L}_\omega}
...
\newcommand{\forget}{\textup{forget}}
\newcommand{\Fbrs}{\textup{\textsf{Fbrs}}}
\newcommand{\F}{\mathbb{F}}
\newcommand{\act}{\textup{act}}
\newcommand{\pb}{\textup{pb}}
\newcommand{\gl}{\textup{gl}}
\newcommand{\eq}{\textup{eq}}
\newcommand{\Bispan}{{\textup{Bispan}}}
\DeclareMathOperator{\Env}{Env}
\DeclareMathOperator{\Ext}{Ext}
\DeclareMathOperator{\Triv}{Triv}
\DeclareMathOperator{\ev}{ev}
\DeclareMathOperator{\laxlim}{lax\,lim}
\newcommand{\plaxlim}{\mathop{\laxlim^{\!\dagger\!}}}
\newcommand{\xto}{\xrightarrow}
\newcommand{\shfy}{{\textup{shfy}}}
\newcommand{\Sqcof}{{\textup{Sq}^\textup{cof}}}
\newcommand{\exttimes}{\mathbin{\widehat{\smash{\times}}}}
...
\newcommand{\CATt}{\mathbf{CAT}}
\newcommand{\Glocatt}{\mathbf{CAT}_{\Glo}}

\newcommand{\PrL}{\textup{Pr}^{\textup{L}}}
\newcommand{\PrR}{\textup{Pr}^{\textup{R}}}
\newcommand{\PrLT}{\textup{Pr}^{\textup{L}}_{T}}
\newcommand{\PrRT}{\textup{Pr}^{\textup{R}}_{T}}
\newcommand{\PrLTst}{\textup{Pr}^{\textup{L,st}}_{T}}
\newcommand{\PrRTst}{\textup{Pr}^{\textup{R,st}}_{T}}
\newcommand{\PrLTsemi}{\textup{Pr}^{\textup{L,$P$-$\oplus$}}_{T}}
\newcommand{\PrRTsemi}{\textup{Pr}^{\textup{R,$P$-$\oplus$}}_{T}}
\newcommand{\PrLTPst}{\textup{Pr}^{\textup{L,$P$-st}}_{T}}
\newcommand{\Rig}{\textup{Rig}}
\newcommand{\LFib}{\textup{LFib}}
\newcommand{\UCom}{\textup{UCom}}
\newcommand{\Glob}{\textup{Glob}}
\renewcommand{\top}{{\textup{top}}}
\newcommand{\botimes}{{\rlap{$\scriptstyle\oplus$}\otimes}}
\newcommand{\ladj}{{\textup{ladj}}}

\newcommand{\ppo}{\mathbin{\raise.25pt\hbox{\scalebox{.67}{$\square$}}}}
\newcommand{\boxsmash}{\mathbin{\raise.5pt\hbox{\rlap{\lower.5pt\hbox{$\square$}}\kern.55pt$\smashp$\kern.55pt}}}
\newcommand{\smallboxsmash}{\mathbin{\raise.35pt\hbox{\rlap{\lower.35pt\hbox{$\scriptstyle\square$}}\kern.375pt$\scriptstyle\smashp$\kern.375pt}}}

\DeclareMathOperator{\essim}{ess\,im}
\renewcommand{\hom}{\textup{hom}}
\newcommand{\Map}{{\textup{hom}}}
\newcommand{\Fun}{{\textup{Fun}}}
\DeclareMathOperator{\PSh}{PSh}
\DeclareMathOperator{\Shv}{Shv}
\DeclareMathOperator{\Ar}{Ar}
\DeclareMathOperator{\Unco}{Un^{co}}
\DeclareMathOperator{\Unct}{Un^{ct}}
\DeclareMathOperator{\Stco}{St^{co}}
\DeclareMathOperator{\Stct}{St^{ct}}
\DeclareMathOperator{\CMon}{CMon}
\DeclareMathOperator{\RelCat}{RelCat}
\DeclareMathOperator{\AdTrip}{AdTrip}
\DeclareMathOperator{\Span}{Span}
\DeclareMathOperator{\SPAN}{SPAN}
\DeclareMathOperator{\Mack}{Mack}
\DeclareMathOperator{\laxlimdag}{{\mathop{\textup{lax\,lim}^\dagger}}}
\newcommand{\Fini}{\operatorname{Fin}_*}

\newcommand{\Ntop}{{N_\textup{top}}}

\newcommand{\tcat}{{\mathcal D}}
\newcommand{\cat}[1]{\textbf{\textup{#1}}}
\newcommand{\HOM}{\cat{Hom}}
\newcommand{\Sect}{{\textup{Sect}}}
\newcommand{\PSH}{\text{PSH}}
\newcommand{\FUN}{\cat{Fun}}
\newcommand{\maps}{\cat{maps}}
...
\newcommand{\Sig}{\smash{\widetilde{\vphantom{t}\smash{\Sigma}}}}
\renewcommand{\hom}{{\textup{Hom}}}
\newcommand{\End}{{\textup{End}}}

\def\decroman#1#2{\global\newcommand{#1}{{\textup{#2}}}}
\DeclareMathOperator{\core}{\iota}
\DeclareMathOperator{\CAlg}{\textup{CAlg}}
\DeclareMathOperator{\Mon}{\textup{Mon}}
\DeclareMathOperator{\Alg}{\textup{Alg}}
\DeclareMathOperator{\St}{\textup{St}}
\newcommand{\colim}{\mathop{\textup{colim}}}
\newcommand{\const}{\textup{const}}
\newcommand{\consto}{\ensuremath{c}}
\newcommand{\consts}{\textup{const}}
\newcommand{\id}{\textup{id}}
\newcommand{\pr}{\textup{pr}}
\renewcommand{\Pr}{\textup{Pr}}
\newcommand{\fgt}{\textup{fgt}}
\newcommand{\diag}{\textup{diag}}
\newcommand{\cocart}{\textup{cc}}
\newcommand{\co}{\textup{cc}}
\newcommand{\strong}{\textup{strong}}
\newcommand{\cart}{\textup{ct}}
\newcommand{\ct}{\textup{ct}}
\newcommand{\BC}{\textup{BC}}
\newcommand{\Un}{\textup{Un}}
\newcommand{\sh}{{\textup{sh}}}
\newcommand{\Fin}{\hbox{$\mathcal F\kern-1.7pt\textit{in}$}}
\newcommand{\bigAll}{\hbox{\hfuzz=20pt\hbox{$\mathcal A\kern-.3pt$}\setbox0=\hbox{$\ell\kern-.75pt\ell$}\hbox to 0pt{\hfuzz=8pt\kern-.075pt\unhcopy0}\hbox to 0pt{\hfuzz=8pt\kern.075pt\unhcopy0}\box0\kern.05pt}}
\newcommand{\smallAll}{\Aa\kern-.3pt\ell\kern-.6pt\ell}
\newcommand{\All}{\mathchoice{\bigAll}{\bigAll}{\smallAll}{\smallAll}}
\newcommand{\dual}{\flat}
\newcommand{\Orb}{{\vphantom{\textup{t}}\smash{\textup{Orb}}}}
\newcommand{\Surj}{\textup{Surj}}
\newcommand{\Glo}{\textup{Glo}}
\newcommand{\res}{\textup{res}}
\newcommand{\ind}{\textup{ind}}
\newcommand{\coind}{\textup{coind}}
\newcommand{\Nm}{\mathop{\vphantom{t}\smash{\textup{Nm}}}\nolimits}
\newcommand{\Ind}{\mathop{\textup{Ind}}\nolimits}
\newcommand{\Res}{\mathop{\textup{Res}}\nolimits}
\newcommand{\Inf}{\mathop{\textup{Inf}\hspace{.1em}}\nolimits}
\newcommand{\Sub}{\mathop{\textup{Sub}}\nolimits}
\DeclareMathOperator{\Nmadj}{\widetilde{\Nm}}
\DeclareMathOperator{\Nmadjdual}{\overline{\Nm}}


\newcommand{\topGrpd}{\cat{topGrpd}}
\newcommand{\grpd}[1]{B_{\textup{top}}{#1}}
\newcommand{\Top}{\cat{Top}}
\newcommand{\GTop}[1]{\cat{$\bm{#1}$-Top}}
\newcommand{\Catone}{\cat{Cat}_1}
\newcommand{\topCat}{\cat{topCat}}
\newcommand{\topCAT}{\cat{TOPCAT}}
\newcommand{\sSet}{\operatorname{sSet}}
\newcommand{\sSET}{\operatorname{sSET}}
\newcommand{\Sing}{\operatorname{Sing}}
\newcommand{\Set}{\operatorname{Set}}
\newcommand{\BGcat}[1]{\mathbb B{#1}}
\renewcommand{\sqcup}{\amalg}
\renewcommand{\bigsqcup}{\coprod}
\newcommand{\Kan}{\operatorname{Kan}}
\renewcommand{\sqcup}{\amalg}
\renewcommand{\bigsqcup}{\coprod}
\newcommand{\Aut}{\textup{Aut}}

\newcommand{\ulhelper}[2]{\underline{\setbox0=\hbox{$#1#2$}\dp0=0.4pt \box0\relax}}
\newcommand{\ul}[1]{{\mathpalette\ulhelper{#1}}\hbox{\rule[-2pt]{0pt}{0pt}}}
\let\und=\ul
...
\tikzset{mono/.style={>->},
         epic/.style={->>},
         norm/.style={->, shorten <=3pt,
		              postaction={decorate,
			                      decoration={markings,
                                              mark=at position 2pt with {\node[fill=white,inner sep=-1pt,circle] {$\scriptscriptstyle\otimes$};}}}}}

\newcommand{\oldrightarrownorm}{\mathrel{
\raise1.3pt\hbox{$\scriptscriptstyle\otimes$}\hskip-1.33pt{\to}}}
\newcommand{\buildarrowfromtikz}[1]{\mathrel{\begin{tikzcd}[ampersand replacement=\&, cramped, cells={nodes={inner sep=0pt}}, column sep=small] \null\arrow[r, #1]\&\null
\end{tikzcd}}}
\newcommand{\rightarrowepic}{\buildarrowfromtikz{epic}}
\newcommand{\rightarrowmono}{\buildarrowfromtikz{mono}}
\newcommand{\rightarrownorm}{\buildarrowfromtikz{norm}}
\newcommand{\buildarrowfromtikzl}[1]{\mathrel{\begin{tikzcd}[ampersand replacement=\&, cramped, cells={nodes={inner sep=0pt}}, column sep=small] \null\&\arrow[l, #1]\null
\end{tikzcd}}}
\newcommand{\leftarrowepic}{\buildarrowfromtikzl{epic}}
\newcommand{\leftarrowmono}{\buildarrowfromtikzl{mono}}

\let\smashp=\wedge

\newcommand{\incl}{{\mathop{\textup{incl}}}}

\newcommand{\iso}{\xrightarrow{\;\smash{\raisebox{-0.25ex}{\ensuremath{\scriptstyle\sim}}}\;}}

\newcommand{\isoname}[1]{\xrightarrow[\;\smash{\raisebox{0.5ex}{\ensuremath{\scriptstyle\sim}}}\;]{#1}}
...
\newcommand{\mySp}{{\mathfrak S\kern-.5pt\mathfrak p}}
\newcommand{\myLSp}{{\mathfrak d\kern-.25pt}\mySp}
\newcommand{\mySph}{{\mathfrak R\kern-.5pt\mathfrak e\kern-.5pt\mathfrak p\kern-.5pt\mathfrak S\kern-.5pt\mathfrak p}}
\newcommand{\mySplev}{\myLSp_\textup{lvl}}
\newcommand{\ulmySplev}{\ul{\myLSp}_\textup{lvl}}
\newcommand{\myS}{{{\mathfrak S\kern-.4pt}}}
\newcommand{\ospc}{{\textbf{\textup{$\cat{L}$-Top}}}}
\newcommand{\osp}{{\textbf{\textup{OrthSp}}}}
\newcommand{\Gosp}[1]{\cat{$\bm{#1}$-OrthSp}}
\newcommand{\Gospc}[1]{\cat{$\bm{#1}$-$\cat{L}$-Top}}
\newcommand{\Glocat}{\textup{CAT}_{\textup{Glo}}}
\newcommand{\Th}{{\textup{Th}}}
\renewcommand{\th}{{\textup{th}}}
\newcommand{\Thmod}{\textup{Th}_{\textup{model}}}
\newcommand{\myTh}{{\mathfrak T\kern-1pt\mathfrak h}}
\newcommand{\myth}{{\mathfrak t\kern-.5pt\mathfrak h}}
\newcommand{\Jmod}{\mathfrak{J}}
\newcommand{\Pic}{\textup{Pic}}
\newcommand{\pic}{\textup{pic}}
\newcommand{\Rep}{\textup{Rep}}
\newcommand{\VRep}{\textup{VRep}}
\newcommand{\Vect}{\textup{Rep}}
\newcommand{\ulVect}{\underline{\textup{Vect}}_{\oplus}}
\newcommand{\BOP}{\cat{BOP}}
\newcommand{\BO}{B\textup{O}}
\newcommand{\Gr}{\cat{Gr}}
\newcommand{\eGr}{\cat{EGr}}
\newcommand{\cofib}{\textup{cofib}}
\newcommand{\Borcat}[1]{N_{\textup{top}}({#1}^{\dual})}
\newcommand{\Borscat}[1]{N_{\textup{top}}({#1}^{\dual})}
\newcommand{\CGrp}{\operatorname{CGrp}}
\newcommand{\grp}{\textup{grp}}
\newcommand{\lax}{\textup{lax}}
\newcommand{\Day}{\textup{Day}}
\newcommand{\cont}{\textup{cont}}
\newcommand{\cc}{\text{cc}}
\newcommand{\ptw}{\text{ptw}}
\newcommand{\Daylax}{\textup{Daylax}}
\newcommand{\Cocart}{\textup{Cocart}}
...
\subsection*{Parametrized higher categories} 
...
\subsection*{Global homotopy theory}
...
\subsection*{Beyond finite groups}
...
\begin{introthm}[See Theorem~\ref{thm:unstable-main}]\label{introthm:unstable-main}
...
\begin{introthm}[See Corollary~\ref{cor:equiv-spaces-universal}]\label{introthm:unstable-equiv}
...
\begin{introcor}[See Corollary~\ref{cor:S-gl-times-initial}]
...
\begin{introthm}[See Theorem~\ref{thm:equiv-main} and Corollary~\ref{cor:equiv-spectra-smash}]\label{introthm:stable-equiv-main}
...
\begin{introthm}[See Theorem~\ref{thm:stable-main} and Corollary~\ref{cor:global-spectra-smash}]\label{introthm:stable-main}
...
\subsection*{Global and equivariant Thom spectra}
...
\begin{introthm}[See Theorem~\ref{thm:MO-as-colim}]\label{introthm:mo-as-colim}
...
\begin{ex}\label{ex:glo-mapping-space}
...
\begin{constr}\label{constr:continuous-Borel}
...
\begin{rk}\label{rk:shift-vs-fun}
...
\begin{rk}\label{rk:Yoneda-image}
...
\begin{rk}\label{rk:internal-hom-pw}
...
\begin{rk}\label{rk:FunT-slice-description}
...
\begin{rk}\label{rk:adjunctions-pw-unit-counit}
...
\begin{rk}\label{rk:adj-via-colims}
...
\begin{ex}[See \cite{CLL_Global}*{Lemmas~2.3.9 and~2.3.10}]\label{ex:existenceconstantcolimits}
...
\begin{rk}[See \cite{martiniwolf2021limits}*{Propositions~4.3.1 and~4.3.2}]
...
\begin{prop}[See \cite{martiniwolf2021limits}*{Proposition~5.4.1}]
...
\begin{thm}[See \cite{martiniwolf2021limits}*{Theorem~6.3.5 and Corollary~6.3.7}]\label{thm:Kan-extension}
...
\begin{constr}\label{constr:Fun-T-cc}
...
\begin{thm}[See \cite{martiniwolf2021limits}*{Theorem 7.1.1}]\label{thm:univ-prop-PSh}
...
\begin{cor}\label{cor:univ-prop-Spc-T}
...
\begin{prop}\label{prop:adj-functor-thm}
    \begin{enumerate}
...
\begin{prop}\label{prop:FunL-presentable}
...
\begin{cor}\label{cor:PrLT-ambidextrous-fgt}
...
\begin{prop}\label{prop:equiv-model-structure}
...
\begin{ex}\label{ex:graph-restr-rQ}
...
\begin{ex}\label{ex:graph-restr-lQ}
...
\begin{rk}\label{rk:h-cof-closure}
...
\begin{rk}\label{rk:fixed-and-restr-preserve-h-cof}
...
\begin{rk}\label{rk:L-top-explicit}
...
\begin{prop}[See \cite{barrero2021}*{Theorem~A.2 and Lemma~A.7}]\label{prop:orth-lvl}
...
\begin{rk}\label{rk:level-cof-are-h-cof}
...
\begin{thm}[See \cite{barrero2021}*{Theorem A.20}]
...
\begin{rk}\label{rk:generating-ayclic-between-cof}
...
\begin{constr}\label{constr:ev-infty}
...
\subsubsection{A presheaf model}
...
\begin{prop}\label{prop:global-Elmendorf}
...
\begin{rk}\label{rk:mathfrak-O-gl-vs-Stefan}
...
\begin{prop}\label{prop:quotient-we-global}
...
\begin{cor}\label{cor:box-product-bifun}
...
\begin{cor}[See also \cite{barrero2021}*{Lemma~3.7(v)}]\label{cor:cart-prod-homotopical}
...
\begin{thm}\label{thm:G-global-as-slice}
...
\begin{cor}\label{cor:slice-adjoint-equiv}
...
\begin{prop}\label{prop:basechange-surj}
    Let 
    \[
        \begin{tikzcd}
...
\begin{thm}\label{thm:unstable-main}
...
\begin{constr}\label{constr:Upsilon}
...
\begin{ex}\label{ex:Upsilon-for-Sgl}
...
\begin{thm}\label{thm:criterion-spc-T}
...
\begin{constr}\label{constr:slice-cat}
...
\begin{prop}\label{prop:the-horrible-proof-we-dont-talk-about}
...
\subsubsection{A model categorical description} 
...
\begin{prop}\label{prop:model-categorical-model}
...
\begin{prop}\label{prop:lc-upsilon-equiv}
    The composite
    \[
...
\begin{thm}\label{thm:Upsilon-ff}
...
\begin{prop}\label{prop:pb-surj-glo}
    Let
...
\subsubsection{$\Ff$-global spaces}
...
\begin{thm}\label{thm:univ-prop-F-gl-spaces}
...
\begin{prop}\label{prop:Orb-Glo-cleft}
...
\begin{prop}[See \cite{CLL_Clefts}*{Lemma~3.17}]
...
\begin{rk}\label{rk:Spc-S-T-as-LKE}
    By the explicit construction of the left adjoint $\ul\Spc_S\to i^*(\ul\Spc_T)$ in \cite{CLL_Clefts}*{Construction 3.15}, $\ul\Spc_{S\triangleright T}$ consists in degree $A\in T$ precisely of those presheaves on $T_{/A}$ that are left Kan extended from $S_{/A}$. \end{rk}
...
\begin{rk}[See \cite{CLL_Clefts}*{Lemma 4.15}]
...
\begin{prop}[See \cite{CLL_Clefts}*{Corollary~4.27}]\label{prop:Spc-S-T-univ-prop}
...
\end{enumerate}
\end{lemma}
\begin{rk}\label{rk:cleft-cc-addendum}
...
\begin{rk}\label{rk:ev-U-ra-const}
...
\begin{thm}\label{thm:unstable-equiv-main}
...
\begin{cor}\label{cor:equiv-spaces-universal}
...
\begin{ex}\label{ex:cartesian-sym-mon}
...
\begin{rk}\label{rk:what-it-means-to-be-cartesian}
...
\begin{cor}\label{cor:Ntop-sym-mon-lift}
...
\begin{constr}\label{constr:sym-mon-Borel}
...
\begin{rk}\label{rk:charact-bilinear}
...
\begin{prop}[See \cite{martiniwolf2022presentable}*{Corollary 2.6.2.5 and Remark~2.6.2.6}]\label{prop:lurie-tensor-exists}
...
\begin{rk}\label{rk:CAlg-for-param-Lurie}
...
\begin{prop}\label{prop:spc-T-cart-pres-sym-mon}
...
\begin{cor}\label{cor:Spc-S-T-x-initial}
...
\begin{cor}\label{cor:S-gl-times-initial}
...
\begin{cor}\label{cor:S-equiv-times-initial}
...
\begin{prop}\label{prop:univ-prop-*-cc}
...
\begin{prop}\label{prop:univ-prop-*-cc-param}
...
\begin{cor}\label{cor:Spc-S-T-*-pres}
...
\begin{prop}\label{prop:Spc*-levelwise-tensor}
...
\begin{cor}\label{cor:gl-pointed}
...
\begin{cor}\label{cor:equiv-pointed}
...
\begin{prop}\label{prop:smash-well-based}
...
\begin{cor}\label{cor:balanced-smash-product-oddly-specific}
...
\begin{prop}\label{prop:boxsmash-qcof}
...
\begin{cor}\label{cor:global-smash-well-based}
...
\begin{rk}\label{rk:idempotent-algs-are-algs}
...
\begin{cor}\label{cor:idempotent-la}
...
\subsubsection{Smashing localizations of $\Pr^S_T$}
...
\begin{cor}\label{cor:smash-initial-general}
...
\subsubsection{Symmetric monoidal structures for global and equivariant based spaces}
...
\begin{constr}\label{constr:smash-product-unstable}
...
\begin{thm}\label{thm:gl-smash-initial}
...
\begin{cor}\label{cor:equiv-smash-initial}
...
\begin{ex}\label{ex:based-global-spaces-tensored}
...
\begin{ex}\label{ex:tensoring-pointwise}
...
\begin{ex}\label{ex:tensoring-slice}
...
\begin{prop}\label{prop:PrS-T-vs-Cat-S-cc}
...
\begin{rk}\label{rk:sym-mon-cocompletion}
...
\begin{thm}\label{thm:sym-mon-localization-for-modes}
...
\begin{cor}\label{cor:stabilization-exists}
...
\begin{cor}\label{cor:SpR-initial}
...
\begin{cor}\label{cor:SpR-sym-mon-univ-prop}
...
\begin{prop}\label{prop:O-mapping-CW}
...
\begin{rk}\label{rk:universe-subgroup}
...
\begin{constr}\label{constr:generating-equiv-acyclic}
...
\begin{prop}[See \cite{mandell-may}*{Proposition~III.3.9 and Theorem~III.3.11}]\label{prop:rep-spheres-invertible-equiv-model}
...
\begin{prop}\label{prop:equiv-sp-compact-gen}
...
\begin{prop}[See \cite{DHLPS2019Proper}*{Theorem~1.66(ii)}]\label{prop:restr-left-Quillen-G-Sp}
...
\begin{prop}\label{prop:i!-left-Quillen-equiv-sp}
...
\begin{prop}[See \cite{DHLPS2019Proper}*{Proposition~1.43}]\label{prop:equiv-smash-sp-left-Quillen-bifunctor}
...
\begin{ex}\label{ex:equiv-cofibrant-flat}
...
\begin{thm}[Stolz]\label{thm:equiv-flatness}
...
\begin{thm}\label{thm:equiv-main}
...
\begin{prop}\label{prop:equiv-sp-pw-univ-property}
...
\begin{prop}\label{prop:equiv-sp-equiv-cc}
...
\begin{prop}\label{prop:sigma-oo-pres-refl-equiv-cc}
...
\begin{cor}\label{cor:equiv-spectra-smash}
...
\begin{prop}\label{prop:global-lvl-GSp}
...
\begin{rk}\label{rk:projections-suffice}
...
\begin{thm}\label{thm:G-gl-Sp-model-struct}
...
\begin{constr}\label{constr:new-gen-cof}
...
\begin{prop}\label{prop:kappa-gl}
...
\begin{prop}\label{prop:gl-flatness}
...
\begin{prop}\label{prop:smash-gl-left-Quillen}
...
\begin{cor}\label{cor:smash-gl-left-Quillen}
...
\begin{constr}\label{constr:diag}
...
\begin{constr}\label{constr:Sigma-bullet}
...
\begin{prop}\label{prop:Sigma-bullet-homotopical-left-Quillen}
...
\begin{prop}\label{prop:resp-stability-G-gl}
...
\begin{prop}\label{prop:gl-spectra-compact-generators}
...
\begin{cor}\label{cor:SpL-level-hcof}
...
\begin{prop}\label{prop:mySplev-unpar-presh}
...
\begin{cor}\label{cor:ev_V-corep}
...
\subsubsection{$G$-global $\Omega$-spectra} 
...
\begin{prop}\label{prop:L-gl-Bousfield}
...
\begin{thm}\label{thm:comp-gl-models}
...
\begin{cor}\label{cor:diag-preserve}
...
\begin{prop}\label{prop:he-preserve-but-he-also-reflec}
...
\begin{cor}\label{cor:LSp-restr-homotopical}
...
\begin{cor}\label{cor:LSp-vs-Sp-param}
...
\begin{prop}\label{prop:Splev-cc}
...
\begin{thm}\label{thm:gl-sp-pres}
...
\subsubsection{Representation stability}
...
\begin{cor}\label{cor:Spgl-rep-stable}
...
\begin{constr}\label{constr:global-smash-product-param}
...
\begin{constr}\label{constr:sigma-bullet-sym-mon}
...
\begin{prop}\label{prop:gl-spectra-pres-sym-mon}
...
\begin{prop}\label{prop:mySp-vs-mySp-gl}
...
\begin{thm}\label{thm:stable-main}
...
\begin{prop}\label{prop:Sigma-oo-lev-ff}
...
\begin{prop}\label{prop:RA-factor-through-LA}
...
\begin{constr}\label{constr:sigma-as-BC}
...
\begin{cor}\label{cor:global-spectra-smash}
...
\begin{rk}\label{rk:not-naive-stab}
...
\begin{rk}\label{rk:gepner-nikolaus}
...
\begin{prop}\label{prop:Day-convolution}
...
\begin{prop}\label{prop:Day-restriction}
...
\begin{rk}\label{rk:slice-vs-shift}
...
\begin{prop}\label{prop:slice-sym-mon-is-universal}
...
\begin{prop}\label{prop:S-T-slice-univ-prop}
...
\begin{ex}\label{ex:post-composition-slice}
...
\begin{constr}\label{constr:definitionjhomomorphism}
...
\begin{constr}\label{constr:global-sph}
...
\begin{rk}\label{rk:equivariant-j}
...
\begin{constr}\label{constr:global-J}
...
\begin{thm}\label{thm:who-is-afraid-of-the-J-homomorphism}
...
\begin{prop}\label{prop:symmetric-monoidal-LKE}
...
\begin{rk}\label{rk:J-with-fewer-models}
...
\end{definition}
\begin{rk}\label{rk:incoherent-description-Thom-gl}
...
We owe the following corollary of the symmetric monoidal universal property of global spectra (Theorem~\ref{thm:stable-main} and Corollary~\ref{cor:global-spectra-smash}) to David Gepner, Thomas Nikolaus, and Stefan Schwede: 
    \begin{cor}\label{cor:Thom-space-po}
...
\end{rk}
\begin{rk}\label{rk:incoherent-description-Thom-equiv}
...
\begin{prop}\label{prop:equiv-thom-from-global}
    The square
...
\begin{thm}\label{thm:Thom-vs-fgt}
...
\medskip
\subsubsection{Thom spaces of (equivariant) vector bundles}
...
\begin{ex}\label{ex:thom-space-1pt}
...
\begin{rk}\label{rk:classical-thom-sym-mon}
...
\begin{constr}\label{constr:thom-over-Gr}
...
\begin{ex}[See \cite{schwede2018global}*{Example~2.3.12}]
...
\begin{ex}[See \cite{schwede2018global}*{Example~2.4.1}]\label{ex:BOP}
...
\begin{constr}\label{constr:Thom-space-functor-gl}
...
\begin{prop}[See Theorem~\ref{thm:Thom-marvelous-appendix}(1)]\label{prop:thom-space-marvelous}
...
\begin{constr}\label{constr:th-on-corep}
...
\begin{prop}\label{prop:th-on-corep-sym-mon}
...
\begin{constr}\label{constr:gl-Thom-space-sym-mon}
...
\begin{prop}\label{prop:gl-Thom-space-la}
...
\begin{constr}\label{constr:Thom-spectrum-functor}
...
\begin{thm}[See Theorem~\ref{thm:Thom-marvelous-appendix}(2)]\label{thm:thom-spectrum-marvelous}
...
\begin{cor}\label{cor:gl-Thom-spectrum-la}
...
\begin{cor}\label{cor:thom-space-vs-thom-spectra} 
...
\begin{thm}\label{thm:Aut-Vect-oplus}
...
\begin{cor}\label{cor:uniqueness-maps-to-O(n)}
...
\begin{prop}\label{prop:Aut-h-Vect}
...
\begin{cor}\label{cor:so-many-centralizers}
...
\begin{prop}\label{prop:Vect-delta-RKE}   
...
\begin{prop}\label{prop:Aut-Vect-delta}
...
\begin{thm}\label{thm:comparing-inputs}
    \begin{enumerate}
...
\begin{constr}[cf.~\cite{juran-thesis}*{Construction~5.5}]
...
\begin{prop}\label{prop:construction-of-psi-otimes}
...
\subsubsection{And now with group completions}
...
\begin{thm}\label{thm:Gr-oup-completion}
...
\begin{prop}\label{prop:group-complete-on-slices}
...
\begin{rk}\label{rk:explicit-description-psi}
...
\begin{thm}\label{thm:comparison-Thom}
    The diagrams
    \[
...
\begin{constr}\label{constr:mop-cocone}
...
\begin{rk}\label{rk:univ-cocone-thom-classes}
...
\begin{prop}\label{prop:MOP-as-colim} 
...
\begin{thm}\label{thm:MO-as-colim}
...
\begin{rk}More generally, Remark~\ref{rk:explicit-description-psi} and Lemma~\ref{lm:pointwise-par-colimit} allow us to describe the $G$-global Thom spectrum of any map $\xi\colon X\to \triv_G\,\BOP$ of orthogonal $G$-spaces as a parametrized colimit: we have an equivalence
...
\begin{thm}\label{thm:MOP-Orb-colim}
    The induced maps
    \[
...
\begin{cor}\label{cor:MOG-as-colim}
    The maps
    \[
...
Constructions~\ref{constr:Thom-space-functor-gl} and~\ref{constr:Thom-spectrum-functor} define a global Thom space and global Thom spectrum functor, respectively, as (symmetric monoidal) topologically enriched functors out of certain slices of the topological category $\cat{$\cat{L}$-Top}$ of orthogonal spaces. Taking $G$-objects on both sides for any compact Lie group $G$ then yields the $G$-global Thom space and Thom spectrum functor. The goal of this appendix is to prove the following result: 
  \begin{thm}\label{thm:Thom-marvelous-appendix} Let $G$ be a compact Lie group. 
\begin{enumerate}
...
\begin{constr}\label{constr:thom-level-right-adjt}Fix an inner product space $V$.
...
\begin{prop}\label{prop:structure_continuous}
